...
Also read: `topics/02-cohesion-and-issues.md` for cohesion rating criteria and issue labels.
...
- See `topics/02-cohesion-and-issues.md` for detection criteria.
