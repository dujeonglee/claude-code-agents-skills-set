# Topic 00 — Calltrace Parsing (R1 Call Order + R2 Context Tracking)
...
Also read: `topics/01-deferred-context.md` for deferred execution linkage.
Also read: `topics/02-locks-and-functions.md` for lock and per-function analysis.
Also read: `topics/04-wifi-domain-knowledge.md` for WiFi domain reference.
