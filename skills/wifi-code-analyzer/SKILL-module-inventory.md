...
- Read: `topics/01-module-identification.md` (boundary detection rules)
...
**Subagent instructions:**
- Read: `topics/02-module-entry-format.md` (exact format specification)
- Read: `topics/03-cohesion-and-issues.md` (cohesion rating + issue labels)
